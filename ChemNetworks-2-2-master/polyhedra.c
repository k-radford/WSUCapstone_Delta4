...
double solvent_dist(double *atmS1, double *atmS1x, double *atmS1y, double *atmS1z, double *atmS1xy, double *atmS1yz, double *atmS1zx, double *atmS1xminy, double *atmS1minyz, double *atmS1zminx, double *atmS1xyz, double *atmS1xyminz,
...
double *pagerank(int ** adjM, int nodes, double damp, double tolerance) // regarded as a directed graph
{
...
void pdfshell(double **shelldistmtx, int shellsize, FILE *outputshellpdf)
{
    int i, j;
